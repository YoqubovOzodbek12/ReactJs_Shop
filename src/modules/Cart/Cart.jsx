...
const Cart = () => {
    ...
    if (!carts.length > 0) return <main>Cart is Empty</main>

    return (
        <main className="relative z-10 after:contents-[''] after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0">
            <div className="w-full  max-w-7xl px-4 md:px-5 lg-6 mx-auto relative z-10">
                <div className="grid grid-cols-12">
                    <div
                            ...
                            <div className="col-span-12 md:col-span-5">
                                <div className="grid grid-cols-5">
                                    ...
                                    <div classNameName="col-span-2">
                                        <p className="font-normal text-lg leading-8 text-gray-400 text-center pl-[80px] ">Total</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-4 w-full">
                                            ...
                                            <div className="flex items-center max-[500px]:justify-center h-full max-md:mt-3">
                                                <div className="flex items-center h-full">
                                                    <button onClick={() => handleDec(cart?.id)}
                                                        ...
                                                        <svg className="stroke-gray-900 cursor-pointer transition-all duration-500 group-hover:stroke-black"
                                                    ...
                                                    <button onClick={() => handleInc(cart?.id)}
                        ...
                        <Link to={'/products'} className="flex items-center justify-start mt-8">
                            <svg className="transition-all duration-500 group-hover:translate-y-2 rotate-180" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <path
                    ...
                    <div className="col-span-12 xl:col-span-4 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto lg:pl-8 py-24 right-1 h-full">
                            ...
                            <div className="mt-8">
                                ...
                                <form>
                                    ...
                                    <div className="flex items-center justify-between py-8">
                                        ...
                                        <p className="font-semibold text-xl leading-8 text-indigo-600">$ {(total + 5).toFixed(2)}</p>
                                    </div>
                                    <button
